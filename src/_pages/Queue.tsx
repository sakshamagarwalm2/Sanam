        ...
        <div className="px-2 py-1">
          ...
          {isChatOpen && (
            ...
            <div className="flex-1 overflow-y-auto mb-3 p-3 rounded-lg bg-black/50 backdrop-blur-md max-h-64 min-h-[120px] glass-content border border-white/20 shadow-lg">
                    ...
                    <div
                      className={`max-w-[80%] px-3 py-1.5 rounded-xl text-xs shadow-md backdrop-blur-sm border ${
                        msg.role === "user" 
                          ...
                          : "bg-white/85 text-black mr-12 border-gray-200/50"
                      }`}
              ...
              {chatLoading && (
                <div className="flex justify-start mb-3">
                  <div className="bg-black/85 text-gray-600 px-3 py-1.5 rounded-xl text-xs backdrop-blur-sm border border-gray-200/50 shadow-md mr-12">
            ...
            >
              <input
                ref={chatInputRef}
                className="flex-1 rounded-lg px-3 py-2 bg-black/25 backdrop-blur-md text-white placeholder-gray-500 text-xs focus:outline-none focus:ring-1 focus:ring-gray-400/60 border border-white/40 shadow-lg transition-all duration-200"
